...
@Component("org.homepisec.sensor.rest.client.api.RelayControllerApi")
public class RelayControllerApi {
     ...
     */
    public void switchRelayUsingPOST(String relayId, Boolean value) throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/api/relays/switch").build().toUriString();
        
        final MultiValueMap<String, String> queryParams = new LinkedMultiValueMap<String, String>();
        final HttpHeaders headerParams = new HttpHeaders();
        final MultiValueMap<String, Object> formParams = new LinkedMultiValueMap<String, Object>();
        
        queryParams.putAll(apiClient.parameterToMultiValueMap(null, "relayId", relayId));
